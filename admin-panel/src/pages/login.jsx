...
const BASE_URL = "http://13.53.193.48:3000";
...
const keyframes = `
  ...
  *::-webkit-scrollbar { display: none; }
  ...
  .support-card      { animation: slideUp 0.5s ease-out; }
  ...
  .eye-hover:hover   { transform: scale(1.1); }
  .back-hover:hover:not(:disabled) { color: #764ba2; }
  ...
  @media (max-width: 480px) {
    .support-card { border-radius: 0; min-height: 100vh; }
  }
`;
